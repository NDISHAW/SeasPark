...
const transporter = nodemailer.createTransport({
  host: "Gmail", // Update with your SMTP host
  port: 465, // Update with your SMTP port
  secure: false, // Update based on your SMTP settings
  auth: {
    user: "ndichumuriithi@", // Update with your email address
    pass: "@wagakungashosho", // Update with your email password
  },
  debug: true,
  // tls: {
...
app.post("/sendEmail", async (req, res) => {
  try {
    const { email, pdfData ,fullName, phoneNumber, jobNumber, message} = req.body;
