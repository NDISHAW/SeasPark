...
const transporter = nodemailer.createTransport({
  host: "smtp.yourdomain.com", // Update with your SMTP host
  port: 587, // Update with your SMTP port
  secure: false, // Update based on your SMTP settings
  auth: {
    user: "your-email@yourdomain.com", // Update with your email address
...
app.post("/sendEmail", async (req, res) => {
  try {
    ...
    // Setup email data
    const mailOptions = {
      from:email "your-email@yourdomain.com", // Update with your email address
      to: ,
