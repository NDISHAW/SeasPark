...
if (!attachment || !attachment.buffer) {
  console.error("Attachment or buffer is missing");
  return res.status(400).send("Attachment or buffer is missing");
}

// Ensure attachment.buffer is properly converted to Buffer
const contentBuffer = Buffer.isBuffer(attachment.buffer)
  ? attachment.buffer
