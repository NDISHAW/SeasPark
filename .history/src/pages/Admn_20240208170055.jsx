...
import axios from "axios";
import { List, Button, TableOne, Seo } from "../components";
import { HeaderOne } from "../containers";
...
const CareerForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="row gx-20 form-style3">
...
const Admin = () => {
  ...
  return (
    <Fragment>
      <Seo title="Careers" />
      <HeaderOne />
      <Breadcrum pageName="Careers" bgImage="images/careers/career2.jpg" />
      <h2>Job Openings</h2>
      <CareerForm onSubmit={handleAddCareer} />
      <CareerList careers={careers} onDelete={handleDeleteCareer} />
      <TableOne />
