...
const TeamSingle = ({ teamMember, ...restProps }) => {
  ...
  if (!teamMember) {
    return null; // or handle the absence of teamMember in a different way
  }
        ...
        <div className="row gx-60 gy-2">
          ...
          <div className="col-lg-7 col-xl-7 align-self-center mb-30">
            <div className="team-about">
              <h3 className="team-name h4">{teamMember.name}</h3>
              <span className="team-degi">
                {" "}
                <h3 className="team-name h4">{teamMember.desgination}</h3>
              </span>
              <p className="team-text">
                Continually utilize 24/365 bandwidth before real-time
                interfaces. Credibly grow team driven core competencies with
                pandemic e-commerce. Objectively initiate pandemic users with
                inexpensive methodologies. Collaboratively deliver
                bricks-and-clicks meta-services for bricks-and-clicks innovation
                streamline front-end experiences.
              </p>
              <div className="row">
          ...
          <div className="row gx-60 gy-3">
            <div className="col-lg-6">
              ...
              <p className="pe-xxl-5">
                Dramatically reinvent worldwide process improvements rather than
                performance based e-business. Holisticly create competitive
                portals for compelling e-markets. Enthusiastically engage B2B
                channels through ethical processes initiate 2.0 applications.
              </p>
              <p>
                Intrinsicly morph bricks-and-clicks e-tailers whereas
                economically sound results disseminate innovative core
                competencies
              </p>
            </div>
            <div className="col-lg-6">
