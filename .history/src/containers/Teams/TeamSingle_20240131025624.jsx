...
import React, { useRef } from 'react';
import { InfoMedia, Button, ProgressOne, TitleWrap, SecSubTitle, SecTitle, FormThree } from '../../components';
      ...
      <div className="container">
        <div className="row gx-60 gy-2">
          <div className="col-lg-5 mb-30">
            ...
            <img src={teamMember ? teamMember.image : "images/team/default-image.jpg"} alt="team-member" />
          </div>
          <div className="col-lg-7 col-xl-7 align-self-center mb-30">
            <div className="team-about">
              <h3 className="team-name h4">{teamMember ? teamMember.name : "Unknown Name"}</h3>
              <span className="team-degi">
                <h3 className="team-name h4">{teamMember ? teamMember.desgination : "Unknown Designation"}</h3>
              </span>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <InfoMedia
                    ...
                    icon="fas fa-user"
                    title="Experience"
                    info={teamMember ? teamMember.experience || "Not specified" : ""}
                  />
                </div>
                <div className="col-sm-6">
                  <InfoMedia
                    ...
                    info={
                      teamMember ? (
                        <a href={`tel:${teamMember.phone}`}>{teamMember.phone || "Not specified"}</a>
                      ) : (
                        ""
                      )
                    }
                ...
                <div className="col-sm-6">
                  <InfoMedia
                    ...
                    info={
                      teamMember ? (
                        <a href={`mailto:${teamMember.email}`}>{teamMember.email || "Not specified"}</a>
                      ) : (
                        ""
                      )
                    }
                ...
                <div className="col-sm-6">
                  <InfoMedia
                    ...
                    info={
                      teamMember ? (
                        <a href={`fax:${teamMember.fax}`}>{teamMember.fax || "Not specified"}</a>
                      ) : (
                        ""
                      )
                    }
          ...
          <div className="row gx-60 gy-3">
            <div className="col-lg-6">
              ...
              <p className="pe-xxl-5">
                {teamMember
                  ? teamMember.personalBiography || "No personal biography available."
                  : "Team member details not found."}
              </p>
              {/* Display teamMember data if available, otherwise use default text */}
              <p>
                {teamMember
                  ? teamMember.additionalInfo || "No additional information available."
                  : ""}
              </p>
            </div>
            <div className="col-lg-6">
              <h3 className="h4 mb-3 pb-1">Professional Skills</h3>
              <ProgressOne title="Business Security" now={teamMember ? teamMember.skills?.businessSecurity || 0 : 0} />
              <ProgressOne title="Career Development" now={teamMember ? teamMember.skills?.careerDevelopment || 0 : 0} />
              <ProgressOne title="Business Innovation" now={teamMember ? teamMember.skills?.businessInnovation || 0 : 0} />
            </div>
          </div>
        </div>
      </div>
