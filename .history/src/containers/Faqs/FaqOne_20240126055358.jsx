    ...
    <div className="container">
      <div className="row gx-60">
        <div className="col-lg-6 pb-20 pb-lg-0">
          <ImageBoxTwo 
            imageOne="images/faq/faq.jpg"
            imageTwo="images/faq/faq2.jpg"
            // video="https://www.dropbox.com/s/b4k0p5swok5l8t2/videoplayback.mp4?dl=1"
          />
        </div>
        <div className="col-lg-6 align-self-center">
          <SecTitle className="text-white"><i className="fas fa-bring-forward"/>Talk About Something</SecSubTitle>
          <SecSubTitle className="text-white mb-4 pb-2 h1 text-capitalize">How can we help you?</SecSubTitle>
