      ...
      <div className="container">
        <Slider className="row" {...settings}>
          <FeatureBoxOne
            ...
            text="We Leverage on our rich, diverse and experienced talent pool to deliver effective staffing and recruitment solutions to our clients. We find the best combination of exemplary skills and cultural fit for our clients thus matching people with growth & success."
