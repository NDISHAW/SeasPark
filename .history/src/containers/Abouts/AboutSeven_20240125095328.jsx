        ...
        <div className="col-lg-6 col-xl-auto">
          <div className="about-box2">
            <SecSubTitle>
              ...
              Get best solution 2022
            </SecSubTitle>
            <SecTitle className="text-capitalize h1">
              Inspiring Tech Needs for Business
            </SecTitle>
            <p>
              Dynamically monetize web-enabled processes through client-based
              action items. Authoritatively grow goal is oriented markets
              through ompletely generate technically sound content without
              robust users.
            </p>
            <div className="row gx-0 align-items-center flex-row-reverse justify-content-end mt-sm-3 pt-sm-3 mb-30 pb-10">
              ...
              <div className="col-sm-auto">
                <InfoMedia
                  ...
                  info={<a href="tel:+25821562154">+(258) 780 170 536</a>}
                />
              </div>
            </div>
            <Button path="/service">
