    ...
    <div className="container">
      <div className="row flex-row-reverse">
        ...
        <div className="col-lg-7 col-xxl-6 me-xl-auto">
          <SecTitle><i className="fas fa-bring-forward"/>The Great Company Skill</SecTitle>
          <SecSubTitle className="h1 text-capitalize">Connecting People And Build Technology</SecTitle>
