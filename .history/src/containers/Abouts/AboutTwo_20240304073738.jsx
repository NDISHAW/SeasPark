      ...
      <div className="row flex-row-reverse">
        ...
        <div className="col-lg-7 col-xxl-6 me-xl-auto">
          ...
          <InfoMedia
            className="about-media"
            image="images/skill/bsecurity.jpg"
            title="Career Development Ensuring the safety and integrity of your operations is our top priority. Our team employs cutting-edge strategies to protect your data and assets, giving you peace of mind."
            info=""
          />
          <InfoMedia
            className="about-media"
