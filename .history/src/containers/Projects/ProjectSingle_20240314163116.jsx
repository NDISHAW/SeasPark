...
// const ProjectSingle = ({ careerr, ...restProps }) => {
...
//             <img src="/images/careerr/career1.jpg" alt="Project" />
//           </div> */}
//             <h2 className="h4">{careerr.title}</h2>
...
//                 {careerr.descriptions &&
//                   careerr.descriptions.map((description, index) => (
//                     <List.Item key={index}>
//                       <i className="fas fa-check-circle" />
//                       {description}
//                     </List.Item>
...
//             <p className="mb-4">
//               <List className="list-style3">
//                 {careerr.requirements &&
//                   careerr.requirements.map((requirement, index) => (
//                     <List.Item key={index}>
//                       <i className="fas fa-check-circle" />
//                       {requirement}
//                     </List.Item>
...
// const ProjectSingle = () => {
//   const { careerr } = useContext(CareerContext);
//   console.log(careerr);
//   return (
//     <div>
//       <div className="container">
