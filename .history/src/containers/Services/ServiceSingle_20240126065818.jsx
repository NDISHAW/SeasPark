      ...
      <div className="row flex-row-reverse">
        <div className="col-lg-8">
          <div className="mb-3 pb-3">
            <img src="images/service/sr-d-1-1.jpg" alt="Project" />
          </div>
          ...
          <p>
            ...
            greater visibility, focus and agility. • Implementation • SAP
            Upgrade & Migration • Roll Out • Expert Consultancy • License sale
          </p>
