  ...
  <div {...restProps}>
    <div className="container">
      <div className="row gx-60 space-top">
        ...
        <div className=" col-xl-8 align-self-center text-center text-xl-start ">
          <SecTitle>{service && service.title}</SecTitle>
                      ...
                      <List className="list-style4" key={subIndex}>
                        ...
                        {subSubService.subnServices &&
                          subSubService.subnServices.length > 0 && (
                            <List className="list-style3">
                              {subSubService.subnServices &&
                                subSubService.subnServices.length > 0 && // Check if subnServices exist and are not empty
                                  ...
                                  (item, itemIndex) => (
                                    <>
                                      <List.Item key={itemIndex}>
                                        ...
                                        {/* </List.Item><List.Item key={itemIndex}> */}
                                        <i className="fal fa-check-circle" />
                                        {item.text}
                                      </List.Item>
                                    </>
