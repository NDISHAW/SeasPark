    ...
    <div className="container">
      <div className="row flex-row-reverse">
        <div className="col-lg-11">
          ...
          <SecTitle>{service.title}</SecTitle>
          ...
          <div className="row gx-0 mb-4 pb-2 pt-3">
            ...
            <div className="col-xl-6">
              <div className="service-list-box">
                <h3 className="h5 title">{service.feature}</h3>
                {service.subSubService.map((subSubService, index) => (
                  <List key={index} className="list-style3">
                    <List.Item>
                      <i className="fal fa-check-circle" /> {subSubService.title}
                    </List.Item>
                  </List>
                ))}
              </div>
