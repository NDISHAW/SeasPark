...
const HeroOne = ()=> {   
  ...
  const HEROCONTENT = [
    ...
    {
      image: "images/hero/Photo by <a href="https://unsplash.com/@sortino?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Joshua Sortino</a> on <a href="https://unsplash.com/photos/worms-eye-view-photography-of-ceiling-LqKhnDzSF-8?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
  ",
      title: (
        <>
          SAP Solutions,
    ...
    },
    {
      ...
      title: (
        <>
          Innovation Anchored in Insight
