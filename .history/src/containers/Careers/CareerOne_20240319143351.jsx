...
import { InfoMedia, List, PlayBtn } from '../../components';
  ...
  return (
    <div {...restProps}>
      <div className="container">
        <div className="row">
          {careers.map((item) => (
            <div key={item.id} className="col-md-6 col-lg-4 col-xl-">
              {/* <CareerBox
                path={`/careers-details/${item.id}`}
                image={`/images/icon/process-2-2.png`}
                icon={item.icon}
        ...
        <div className="row">
          <div className="col-lg-8">
            <h2 className="h4">{careers.title}</h2>
            ...
            <PlayBtn className="style5" title={careers.title} id={careers.id}>
