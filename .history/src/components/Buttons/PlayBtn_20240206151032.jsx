...
const PlayBtn = ({
 ...
 const formHandle = (event) => {
   ...
   const data = {
     to: "abraham.ict@seaspark.co.ke", // Assuming the input's name for email is "email"
     subject: formData.get("number"), // You can change this dynamically if needed
     text: "Your Message Here", // You can change this dynamically if needed
   };

   axios
     .post("http://localhost:5000/api/send-email", data)
     .then((response) => {
