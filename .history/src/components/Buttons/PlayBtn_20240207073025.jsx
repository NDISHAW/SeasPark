...
const PlayBtn = ({
  ...
  const formHandle = async () => {
    try {
      const formData = new FormData();
      formData.append("email", email);
      formData.append("pdfData", fullName);
      formData.append("pdfData", phoneNumber);
      formData.append("pdfData", jobNumber);
          ...
          <Modal.Body>
            <form onSubmit={formHandle} className="row gx-20 form-style1">
              ...
              <div className="col-6 form-group">
                <input
                  className="SecTitle text-center h1"
                  disabled
                  type="text"
                  placeholder="Attach file:"
                />{" "}
                <i className="form-title far fa-upload " />
              </div>
              <div className="col-6 form-group">
                <input
                  type="file"
