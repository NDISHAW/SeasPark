...
const MobileMenu = () => {
  ...
  return (
    <Fragment>
      <button
        className={`vs-menu-toggle style-text`}
        onClick={toggleMenu}
      >
        <i className="far fa-bars"></i>
      </button>
      <div className={`vs-menu-wrapper ${menuOpen ? "vs-body-visible" : ""}`}>
        <div className="vs-menu-area text-center">
          <button className="vs-menu-toggle style-text" onClick={toggleMenu}>
            <i className="fal fa-times"></i>
          </button>
